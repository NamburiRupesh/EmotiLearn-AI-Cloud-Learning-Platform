...
def teacher_dashboard():
    if session.get("role") != "teacher": return redirect(url_for("login_page"))
    ...
    return render_template("teacher_dashboard.html", stats=stats, recent_courses=recent_courses)
...
def parent_dashboard():
    if session.get("role") != "parent": return redirect(url_for("login_page"))
